...
public class Order extends AggregateRoot<OrderId> {
    ...
    public void paymentfailed(List<String> failureMessages) {
        orderStatus = OrderStatus.PAYMENT_FAILED;
        updateFailureMessages(failureMessages);
    }
    public void cancelbykitchen(List<String> failureMessages) {
        if (!(orderStatus == OrderStatus.PENDING || orderStatus == OrderStatus.CANCELLING||orderStatus == OrderStatus.APPROVED)) {
    ...
    private void updateFailureMessages(List<String> failureMessages) {
        ...
        if (this.failureMessages == null) {
            // SỬA LẠI: Luôn tạo một ArrayList mới có thể thay đổi được
    ...
    private Order(Builder builder) {
        ...
        failureMessages = builder.failureMessages != null
                ? new ArrayList<>(builder.failureMessages)
                : new ArrayList<>();
    }
    ...
    public static final class Builder {
        ...
        public Builder orderStatus(OrderStatus orderStatus2) {
