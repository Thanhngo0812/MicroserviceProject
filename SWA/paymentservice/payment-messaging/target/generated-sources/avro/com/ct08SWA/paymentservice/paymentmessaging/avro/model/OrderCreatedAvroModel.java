 ...
 */
package com.ct08SWA.paymentservice.paymentmessaging.avro.model;
...
public class OrderCreatedAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7601875567382766781L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderCreatedAvroModel\",\"namespace\":\"com.ct08SWA.paymentservice.paymentmessaging.avro.model\",\"doc\":\"Model Avro cho sự kiện order được tạo (chuẩn hóa logicalType)\",\"fields\":[{\"name\":\"orderId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"customerId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"restaurantId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"trackingId\",\"type\":[\"null\",{\"type\":\"string\",\"logicalType\":\"uuid\"}],\"default\":null},{\"name\":\"price\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":10,\"scale\":2}},{\"name\":\"createdAt\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"items\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"OrderItemAvroModel\",\"fields\":[{\"name\":\"productId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"price\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":10,\"scale\":2}},{\"name\":\"subTotal\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":10,\"scale\":2}}]}}}]}");
  ...
  private java.util.List<com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderItemAvroModel> items;
   ...
   */
  public OrderCreatedAvroModel(java.util.UUID orderId, java.util.UUID customerId, java.util.UUID restaurantId, java.util.UUID trackingId, java.math.BigDecimal price, java.time.Instant createdAt, java.util.List<com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderItemAvroModel> items) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: items = (java.util.List<com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderItemAvroModel>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.List<com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderItemAvroModel> getItems() {
    return items;
  }
   ...
   * @param value the value to set.
   */
  public void setItems(java.util.List<com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderItemAvroModel> value) {
    this.items = value;
  }
   ...
   */
  public static com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder newBuilder() {
    return new com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder();
  }
   ...
   * @return A new OrderCreatedAvroModel RecordBuilder
   */
  public static com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder newBuilder(com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder other) {
    if (other == null) {
      return new com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder();
    } else {
      return new com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder(other);
    }
  }
   ...
   * @return A new OrderCreatedAvroModel RecordBuilder
   */
  public static com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder newBuilder(com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel other) {
    if (other == null) {
      return new com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder();
    } else {
      return new com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderCreatedAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderId)) {
        this.orderId = data().deepCopy(fields()[0].schema(), other.orderId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder setCustomerId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder setRestaurantId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder clearRestaurantId() {
      restaurantId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder setTrackingId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder clearTrackingId() {
      trackingId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder setItems(java.util.List<com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderItemAvroModel> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderCreatedAvroModel.Builder clearItems() {
      items = null;
    ...
    public OrderCreatedAvroModel build() {
      try {
        ...
        record.items = fieldSetFlags()[6] ? this.items : (java.util.List<com.ct08SWA.paymentservice.paymentmessaging.avro.model.OrderItemAvroModel>) defaultValue(fields()[6]);
        return record;
