...
public class OrderCreatedEventKafkaListener {
    ...
    public OrderCreatedEventKafkaListener(RestaurantApprovalMessageListener restaurantApprovalMessageListener, ObjectMapper objectMapper,RestaurantDataMessagingMapper restaurantDataMessagingMapper) {
     ...
     */
    @KafkaListener(
            topics = "${restaurant-service.kafka.listen-order-create-topic}",
