 ...
 */
@Entity
@Table(name = "user_outbox", schema = "\"user\"")
public class UserOutboxEntity {
     ...
     * SỬA LẠI: Nhận byte[]
     */
    public UserOutboxEntity(UUID id, UUID sagaId, ZonedDateTime createdAt, String eventType, String  payload,String status) {
        this.id = id;
        this.sagaId = sagaId;
    ...
    public static final class Builder {
        ...
        public UserOutboxEntity build() {
            ...
            return new UserOutboxEntity(id, sagaId, createdAt, eventType, payload,status);
        }
    }
}